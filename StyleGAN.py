...
def load_generator(stylegan_path, device='cpu', stylegan_size=1024, style_dim=512, n_mlp=8):
    generator = Generator(stylegan_size, style_dim, n_mlp)
